...
<head>
    ...
    <script src="/resources/js/addCVScript.js"></script>
</head>
<body>
<nav class="navbar navbar-light bg-light">
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/account/myCV">Мои резюме</a>
            </li>
    ...
    <div class="row justify-content-center">
        <div class="col-5">
            <div class="text-center">
                <form class="form-signin" id="add-post-form" action="/account/addMyCV" method="post">
                    <h1 class="h3 mb-3 font-weight-normal">Добавить резюме</h1>
                    <input type="text" name="content" id="content" class="form-control" placeholder="Текст резюме" required autofocus>
                    <br>
